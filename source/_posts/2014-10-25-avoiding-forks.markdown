---
layout: post
title: "Avoiding Forks"
date: 2014-10-25 19:48
comments: false
categories: [Rails, Gems, Forks]
---
...
Well, the easiest way to go about fixing that is to create a new gem. You know what they say, fight gems with gems!
 Or something like that... Anyhow, there's a couple nice pros to making a new gem:
...
- Provides a consistent way to override gem functionality. Some projects have folders of overrides and references to tons of forks.
...
- Naming the gem properly "gemname-module_name_space_to_override". ```Doorkeeper::LogoutRedirect``` in this case to keep the module
structure in place.
...
to how you do extensions.

* We call them gem extensions at AMA. If there's a different name for this, let me know.